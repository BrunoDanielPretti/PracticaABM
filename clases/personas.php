    ...
    class Persona{
        ...
        public static function MostrarPersonasVector(){
            ...
            foreach ($listaPersonas as $key) {
                ...
                $datos .= "<li>";
                $datos .= $key->ToString();
                //$datos .= "<button onclick='borrar"."('$p')"."' class='btn btn-danger'>Borrar</button>";
                $datos .=  "<button onclick="."borrar('$key->_nombre')"." class='btn btn-danger btn-xs'>Borrar</button>";
                $datos .=  "<button onclick="."modificar('$key->_nombre')"." class='btn btn-warning btn-xs'>Modificar</button>";
                $datos .= "</li>";
            }
            $datos .= "</ul>";
            return $datos;
